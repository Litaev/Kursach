    ...
    function confirmAction(){
        if (status.isEditRefueling == false){
            if (refuelingLitreAmountTextField.text != "" && pricePerLitreTextField.text != "" && refuelingMileageTextField.text != ""|| pricePerLitreTextField.text != "" && refuelingPriceTextField.text != "" && refuelingMileageTextField.text != "" || refuelingLitreAmountTextField.text != "" && refuelingPriceTextField.text != "" && refuelingMileageTextField.text != ""){
                // if (refuelingLitreAmountTextField.text != "" && pricePerLitreTextField.text != ""){
                //     user.addEvent(1, "Refueling", parseFloat(refuelingLitreAmountTextField.text)*parseFloat(pricePerLitreTextField.text), refuelingDateTextField.text, refuelingMileageTextField.text, refuelingCommentTextField.text, 0, refuelingLitreAmountTextField.text, pricePerLitreTextField.text);
                // }
                // else if (pricePerLitreTextField.text != "" && refuelingPriceTextField.text != ""){
                //     user.addEvent(1, "Refueling", refuelingPriceTextField.text, refuelingDateTextField.text, refuelingMileageTextField.text, refuelingCommentTextField.text, 0, parseFloat(refuelingPriceTextField.text)/parseFloat(pricePerLitreTextField.text), pricePerLitreTextField.text);
                // }
                // else if (refuelingLitreAmountTextField.text != "" && refuelingPriceTextField.text != ""){
                //     user.addEvent(1, "Refueling", refuelingPriceTextField.text, refuelingDateTextField.text, refuelingMileageTextField.text, refuelingCommentTextField.text, 0, refuelingLitreAmountTextField.text, parseFloat(refuelingPriceTextField.text)/parseFloat(refuelingLitreAmountTextField.text));
                // }
            ...
            if (refuelingLitreAmountTextField.text != "" && pricePerLitreTextField.text != "" && refuelingMileageTextField.text != ""|| pricePerLitreTextField.text != "" && refuelingPriceTextField.text != "" && refuelingMileageTextField.text != "" || refuelingLitreAmountTextField.text != "" && refuelingPriceTextField.text != "" && refuelingMileageTextField.text != ""){
                // if (refuelingLitreAmountTextField.text != "" && pricePerLitreTextField.text != ""){
                //     user.editChosenEventInfo(status.chosenEventId, 1, "Refueling", parseFloat(refuelingLitreAmountTextField.text)*parseFloat(pricePerLitreTextField.text), refuelingDateTextField.text, refuelingMileageTextField.text, refuelingCommentTextField.text, refuelingLitreAmountTextField.text, pricePerLitreTextField.text, 0);
                // }
                // else if (pricePerLitreTextField.text != "" && refuelingPriceTextField.text != ""){
                //     user.editChosenEventInfo(status.chosenEventId, 1, "Refueling", refuelingPriceTextField.text, refuelingDateTextField.text, refuelingMileageTextField.text, refuelingCommentTextField.text, parseFloat(refuelingPriceTextField.text)/parseFloat(pricePerLitreTextField.text), pricePerLitreTextField.text, 0);
                // }
                // else if (refuelingLitreAmountTextField.text != "" && refuelingPriceTextField.text != ""){
                //     user.editChosenEventInfo(status.chosenEventId, 1, "Refueling", refuelingPriceTextField.text, refuelingDateTextField.text, refuelingMileageTextField.text, refuelingCommentTextField.text, refuelingLitreAmountTextField.text, parseFloat(refuelingPriceTextField.text)/parseFloat(refuelingLitreAmountTextField.text), 0);
                // }
