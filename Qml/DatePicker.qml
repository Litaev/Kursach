...
Dialog {
    ...
    header: Item {
        ...
        function initialize()
        {
            ...
            topBar.year = mainWindow.year;
            topBar.month = mainWindow.month;
        }
            ...
            Column {
                ...
                MonthGrid {
                    ...
                    delegate: Item {
                        ...
                        function dayNumberColor(year, month, day)
                        {
                            ...
                            if(calendarGrid.isDateSelectable(year, month, day))
                            {
                                ...
                                {
                                    if(year == mainWindow.year
                                    && month == mainWindow.month
                                    && day == mainWindow.day)
                                    {
                    ...
                    onClicked: (date)=> {
                        ...
                        {
                            mainWindow.year = year;
                            mainWindow.month = month;
                            mainWindow.day = day;
